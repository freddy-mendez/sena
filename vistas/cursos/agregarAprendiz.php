...
<body>
    <div class="container">
        ...
        <a href="listarAprendices.php?id=<?php echo $id; ?>" class="btn btn-success">Agregar Aprendiz</a>
        <br><br>
        <?php
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    foreach($curso->aprendices as $posicion => $aprendiz) {
                        ...
                        <td>
                            <a href="deleteAprendizCurso.php?id=<?php echo $id; ?>&idAprendiz=<?php echo $posicion; ?>" class="btn btn-danger">Eliminar</a>
                        </td>
                        <?php
                        echo "</tr>";
                    }
